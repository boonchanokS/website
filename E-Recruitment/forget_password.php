...
<html lang="en">
	...
	<body class="no-skin textnalmal">
		...
		<div class="main-container" id="main-container">
            ...
            <form class="form-horizontal" method="post" role="form" name="form1" id="form1" action="forget_process.php" onsubmit="return checkBeforAccept();"> 
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
					<input type="text" maxlength="13" class="col-xs-10 col-sm-5" name="idcardno" id="idcardno" placeholder="(เฉพาะตัวเลขเท่านั้น)">

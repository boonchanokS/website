...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="user\assets\font-awesome\4.2.0\css\font-awesome.min.css"> 
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="user\assets\css\ace.min.css" class="ace-main-stylesheet" id="main-ace-style">
		...
		<script src="user\assets\js\ace-extra.min.js"></script>
				...
				<div class="navbar-buttons navbar-header pull-right" role="navigation">
					<ul class="nav ace-nav">
						...
						<li class="light-blue">
							...
							<a href="#">
								<img src="image\thai.jpg" width="60%">
							</a>
						</li>
					</ul>
				</div>
			...
			-->
                    <li class="">
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="https://th.jobsdb.com/th/th/jobs/companies/sumitomo-rubber-thailand-co-ltd/1" target="_blank">
									<i class="menu-icon fa fa-caret-right"></i>
							...
							<li class="">
								<a href="https://www.jobthai.com/company/0,57692.html" target="_blank"> 
									<i class="menu-icon fa fa-caret-right"></i>
...
รายชื่อผู้ได้รับการคัดเลือก</a>
				...
				<table id="dynamic-table" class="table table-striped table-bordered table-hover" >
					<thead>
						<tr>
							...
							<th><i class="ace-icon fa fa-suitcase bigger-110 hidden-480 red"></i> ตำแหน่ง</th>
							<th class="hidden-480"><i class="ace-icon fa fa-user bigger-110 hidden-480 green"></i>  อัตรา</th>
							<th><i class="ace-icon fa fa-university bigger-110 hidden-480 blue"></i>หน่วยงาน</th>
							
							<th class="hidden-480">
								<i class="ace-icon fa fa-clock-o bigger-110 hidden-480 orange"></i> วันที่เปิดรับสมัคร
							</th>
							<th>
								<i class="ace-icon fa fa-clock-o bigger-110 hidden-480 orange2"></i> วันที่ปิดรับสมัคร
							</th>
					...
					<tbody>
						...
						<td>
							<a href="user\job\view.php?id=3252">Production Planning Control Officer</a>
							</td>
						<td class="hidden-480 center">
								1 Position	
						</td> 
						<td>
							Sumitomo Rubber (Thailand) Co.,Ltd <br> ปฏิบัติงาน : นิคมอุตสาหกรรมอมตะซิตี้ (ระยอง) จ.ระยอง
						</td>
						<td class="hidden-480 center">
								26 มิถุนายน 2563							
							</td>
						...
						<tr>
							<td class="center">
								2							</td>
							<td>
								<a href="user\job\view-1.html?id=3251">Engineer Factory Automation (IT Programmer)</a>
							</td>
							<td class="hidden-480 center">
								1 Position							
							</td> 
						...
						<td>
							<a href="user\job\view.html?id=3252">Officer or Sr.Officer Accounting</a>
							</td>
						<td class="hidden-480 center">
								1 Position	
						</td> 
						...
						<td class="hidden-480 center">
							...
							<td class="hidden-480">
								<div class="hidden-sm hidden-xs action-buttons">
									<a href="user\job\view.html?id=3252">
										<span class="blue">
											<i class="ace-icon fa fa-search-plus bigger-120"></i>
										</span>
										</a>
		...
		<!--[if !IE]> -->
		<script src="user\assets\js\jquery.2.1.1.min.js"></script> 
...
<![endif]-->
		<script type="text/javascript">
			if('ontouchstart' in document.documentElement) document.write("<script src='user/assets/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
		</script>
		<script src="user\assets\js\bootstrap.min.js"></script>

		<!-- page specific plugin scripts -->
		<script src="user\assets\js\jquery.dataTables.min.js"></script>
		<script src="user\assets\js\jquery.dataTables.bootstrap.min.js"></script>
		<script src="user\assets\js\dataTables.tableTools.min.js"></script>
		<script src="user\assets\js\dataTables.colVis.min.js"></script>

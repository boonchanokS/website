			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-buttons navbar-header pull-right" role="navigation">
					<ul class="nav ace-nav">
						...
						<li class="light-blue">
                        	<a href="#">
								<i class="ace-icon fa fa-user"></i>ADMIN-014200
							</a>
						</li>
						<li class="light-blue">
							...
							<dl class="dl-horizontal " id="dt-list-1">
								<ul class="list-unstyled spaced horizontal">
									...
									<li>	
										...
										<dd>
										<input type="text" name="username" placeholder="ระบุตำแหน่ง" required="">
										</dd>
										
									</li>
									<li>
										<dt>จำนวน  : </dt>
										<dd><input type="text" name="username" placeholder="ระบุจำนวน" required=""> </dd>
									</li>
									<li>
										<dt>ประเภทบุคคล : </dt>
										<dd><input type="text" name="username" placeholder="ระบุประเภทบุคคล" required=""></dd>
									</li>
									<li>
										<dt>สังกัด :</dt>
										<dd><input type="text" name="username" placeholder="ระบุสังกด" required=""></dd>
									</li> 
									<li>
										<dt>ปฏิบัติงาน :  </dt>
										<dd><input type="text" name="username" placeholder="ระบุปฏิบัติงาน" required=""></dd>
									</li> 
									<li>
										<dt>ระดับการศึกษา  : </dt>
										<dd>
										<select name="cars" id="cars">
										  <option value="volvo">มัธยมศึกษาปีที่ 3</option>
										  <option value="saab">มัธยมศึกษาปีที่ 6</option>
										  <option value="mercedes"> ปวช.</option>
										  <option value="audi">ปวส.</option>
										  <option value="audi">อนุปริญญา</option>
										  <option value="audi">ปริญญาตรี</option>
										  <option value="audi">ปริญญาโท</option>
										  <option value="audi">ปริญญาเอก</option>
										</select>
									...
									<li>
										<dt>ประสบการณ์  :</dt>
										<dd><input type="text" name="username" placeholder="ระบุประสบการณ์" required=""></dd>
									</li>
																		<li>
										<dt>คุณสมบัติผู้สมัคร  :</dt>
										<dd><textarea id="editor" name="editor" rows="4" cols="50"  placeholder="ระบุคุณสมบัติ"></textarea>
										</dd>
<!--
									</li>
																		<li>
							...
							<li>
								...
								<dd><textarea id="editor1" name="editor1" rows="4" cols="50"  placeholder="ระบุหน้าที่ความรับผิดชอบ"></textarea>
									...
									<li>
										...
										<dd><textarea id="editor1" name="editor1" rows="4" cols="50"  placeholder="ระบุหน้าที่ความรับผิดชอบ"></textarea></dd>
									</li>
									<li>
										<dt>เอกสารประกอบ  : </dt>
										<dd>
										<input type="file" name="username" placeholder="อัพโหลด" required="">
										</dd>
									</li>

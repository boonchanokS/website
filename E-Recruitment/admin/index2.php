		...
		<div class="col-sm-12">
			...
			<br>
				<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
					<li >
						<a data-toggle="tab" href="index.php"><i class="fa fa-user" aria-hidden="true"></i>
ประกาศรับสมัครงาน</a>
					</li>
					
					<li class="active" >
						<a data-toggle="tab"  href="index2.php"><i class="fa fa-user " aria-hidden="true"></i>
...
รายชื่อผู้ได้รับการคัดเลือก</a>
			...
			<div class="widget-box widget-color-grey">  
				<div class="widget-header">
					...
					รายการประกาศรายชื่อผู้มีสิทธิเข้าสอบและสอบสัมภาษณ์ 					</h3>
				</div >
			</div>
				...
				<table id="dynamic-table2" class="table table-striped table-bordered table-hover">
					<thead>
						<tr>
							...
							<th class="hidden-480">
								<i class="ace-icon fa fa-bullhorn bigger-110 hidden-480 orange"></i> สถานะ 
							</th>
							...
							<th >
								<i class="ace-icon fa fa-clock-o bigger-110 hidden-480 orange2"></i> วันที่ประกาศ
							</th>
					...
					<tbody>
						...
						<tr>
							...
							<td class="hidden-480">
								<span class="label label-info arrowed">ประกาศรายชื่อ</span>							</td>
							<td>
								
																	<a href="https://muhr.mahidol.ac.th/E-Recruitment/user/job/view.php?id=3108">นักวิชาการคอมพิวเตอร์(พัฒนาระบบสารสนเทศบัณฑิตวิทยาลัย)</a>
															</td>
							<td class="hidden-480">
								1 อัตรา							</td>
							<td>
								บัณฑิตวิทยาลัย<br>ปฏิบัติงาน : มหาวิทยาลัยมหิดล ศาลายา							</td>
							...
							<td class="hidden-480">
								<div class="hidden-sm hidden-xs action-buttons">
																			<a class="blue" href="https://muhr.mahidol.ac.th/E-Recruitment/user/job/view.php?id=3108">
									...
									<div class="inline pos-rel">
										...
										<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
											<li>
																									...
																									<a href="https://muhr.mahidol.ac.th/E-Recruitment/user/job/view.php?id=3108" class="tooltip-info" data-rel="tooltip" title="View">
													<span class="blue">

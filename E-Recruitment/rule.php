		...
		<div class="main-container" id="main-container">
			...
			<div class="main-content">
				...
				<div class="row">
					...
					<div class="col-sm-9">ข้อกำหนดและเงื่อนไขการสมัครสมาชิก</div>
				</div>
				<div class="row">
					<div class="col-sm-2 text-right">1.&nbsp;&nbsp;</div> 
					<div class="col-sm-9">ผู้ที่ต้องการสมัครสมาชิก จะต้องกรอกข้อมูลที่เป็นจริงเพื่อสิทธิประโยชน์ของท่าน หากมหาวิทยาลัยมหิดลตรวจสอบพบว่า ท่านให้ข้อมูลเท็จ ทีมงานมีสิทธิ์ยกเลิกการเป็นสมาชิกได้</div>
				</div>
				<div class="row">
					<div class="col-sm-2 text-right">2.&nbsp;&nbsp;</div> 
					<div class="col-sm-9">ผู้ใดแอบอ้าง หรือกระทำการใดๆ อันเป็นการละเมิดสิทธิ์ส่วนบุคคล โดยใช้ข้อมูลของผู้อื่นมาแอบอ้างสมัครสมาชิก เพื่อให้ได้สิทธิ์การสมาชิก ถือเป็นความผิด ต้องรับโทษตามที่กฎหมายกำหนดไว้</div>
				</div>
				<div class="row">
					<div class="col-sm-2 text-right">3.&nbsp;&nbsp;</div> 
					<div class="col-sm-9">ผู้สมัครยินยอมให้มหาวิทยาลัยมหิดล เก็บ ใช้ เปิดเผย และ/หรือ ประมวลผลข้อมูลส่วนบุคคลของผู้สมัครเพื่อวัตถุประสงค์เกี่ยวกับการสมัครงานเพื่อวัตถุประสงค์ตามที่ระบุไว้เบื้องล่าง ดังนี้</div>
				</div>
				<div class="row">
					<div class="col-sm-3 text-right">3.1.&nbsp;&nbsp;</div> 
					<div class="col-sm-9">เพื่อตรวจสอบคุณสมบัติของผู้สมัครสำหรับการสมัครงงาน</div>
				</div>
				<div class="row">
					<div class="col-sm-3 text-right">3.2.&nbsp;&nbsp;</div> 
					<div class="col-sm-9">เพื่อมหาวิทยาลัยมหิดลสามารถค้นหาผู้สมัครที่มีคุณสมบัติเหมาะสมกับตำแหน่งงานที่ทางมหาวิทยาลัยมหิดลเปิดรับสมัคร</div>
				</div>
				<div class="row">
					<div class="col-sm-3 text-right">3.3.&nbsp;&nbsp;</div> 
					<div class="col-sm-9">เพื่อให้มหาวิทยาลัยนำข้อมูลของท่านไปใช้ประโยชน์เพื่อการบิหารจัดการตามพันธกิจของมหาวิทยาลัย</div>
				</div>
				<div class="row">
					<div class="col-sm-3 text-right">3.4.&nbsp;&nbsp;</div> 
					<div class="col-sm-9">เพื่อเก็บข้อมูลสถิติเกี่ยวกับผู้ใช้งาน สำหรับวิเคราะห์การใช้งานของเว็บไซต์ เพื่อช่วยพัฒนาการใช้งานภายในของเว็บไซต์ให้ดีขึ้น</div>
				</div>
